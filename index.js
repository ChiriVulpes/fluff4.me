...
define("Fluff4me", ["require", "exports", "ui/UiEventBus", "utility/Env", "utility/Popup"], function (require, exports, UiEventBus_1, Env_1, Popup_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class Fluff4me {
        ...
        async main() {
            ...
            async function openOAuthPopup(serviceName) {
                await (0, Popup_1.default)(`${Env_1.default.API_ORIGIN}auth/${serviceName.toLowerCase()}/begin`, 600, 900)
            ...
            for (const service of ["GitHub", "Discord"]) {
                ...
                unoauthbutton.addEventListener("click", async () => {
                    ...
                    if (id === undefined)
                        return;
                    await fetch(`${Env_1.default.API_ORIGIN}auth/remove`, {
                        method: "POST",
                        credentials: "include",
                        headers: {
            ...
            signupbutton.addEventListener("click", async () => {
                await fetch(`${Env_1.default.API_ORIGIN}author/create`, {
                    method: "POST",
                    credentials: "include",
                    headers: {
                        "Content-Type": "application/json",
            ...
            resetSessionButton.addEventListener("click", async () => {
                await Session.refresh(await fetch(`${Env_1.default.API_ORIGIN}session/reset`, {
                    method: "POST",
                    credentials: "include",
                    headers: {
                        "Accept": "application/json",
            ...
            viewprofilebutton.addEventListener("click", async () => {
                // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment
                const response = await fetch(`${Env_1.default.API_ORIGIN}author/chiri/get`, {
                    credentials: "include",
            ...
            updateAuthorButton.addEventListener("click", async () => {
                await fetch(`${Env_1.default.API_ORIGIN}author/update`, {
                    method: "POST",
                    credentials: "include",
                    headers: {
                        "Accept": "application/json",
            ...
            createWorkButton.addEventListener("click", async () => {
                await fetch(`${Env_1.default.API_ORIGIN}work/create`, {
                    method: "POST",
                    credentials: "include",
                    headers: {
                        "Content-Type": "application/json",
            ...
            viewWorkButton.addEventListener("click", async () => {
                // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment
                const response = await fetch(`${Env_1.default.API_ORIGIN}work/a-fancy-story/get`, {
                    credentials: "include",
                }).then(response => response.json());
                console.log(response);
            });
            ...
            updateWorkButton.addEventListener("click", async () => {
                await fetch(`${Env_1.default.API_ORIGIN}work/a-fancy-story/get`, {
                    method: "POST",
                    credentials: "include",
                    headers: {
                        "Content-Type": "application/json",
            ...
            deleteWorkButton.addEventListener("click", async () => {
                await fetch(`${Env_1.default.API_ORIGIN}work/a-fancy-story/delete`, {
                    method: "POST",
                    credentials: "include",
                    headers: {
                        "Content-Type": "application/json",
